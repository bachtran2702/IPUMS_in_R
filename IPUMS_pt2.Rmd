...
chart.Correlation(raw_corr_matrix, histogram = T, method = "spearman")#assuming on-parametric and does non-linear relationship
...
# Create data split 80-20 for validation
