...
#font
font = font_add_google("Roboto", "Roboto")
...
#data viz of total sample 2018-2023. not for publictation
...
print(chart.Correlation(raw_corr_matrix, histogram = T, method = "spearman")) #assuming non-parametric and had a non-linear relationship
...
``` {r removing_correlated_predictor_and_random_sampling, echo = T}
