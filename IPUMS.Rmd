...
base_degree_post_secondary_excl_aa = data %>% #qty of post degree excl. AA 
...
ggplot(college_to_non_college_str_sum, aes(YEAR, count, group = EDUCD_classifier)) +
  geom_bar()
